...
public class HealthyFoodController {
    ...
    public ResponseEntity<List<Meal>> getMeals(@RequestParam int calories, @RequestParam List<String> excludedIngredients, @RequestParam List<String> diet, String category) {
